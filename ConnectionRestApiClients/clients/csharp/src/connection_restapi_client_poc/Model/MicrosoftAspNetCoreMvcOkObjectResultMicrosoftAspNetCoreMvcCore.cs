...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Microsoft_AspNetCore_Mvc_OkObjectResult-Microsoft_AspNetCore_Mvc_Core")]
    public partial class MicrosoftAspNetCoreMvcOkObjectResultMicrosoftAspNetCoreMvcCore : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicrosoftAspNetCoreMvcOkObjectResultMicrosoftAspNetCoreMvcCore" /> class.
        /// </summary>
        ...
        public MicrosoftAspNetCoreMvcOkObjectResultMicrosoftAspNetCoreMvcCore(Object value = default(Object), List<Object> formatters = default(List<Object>), List<string> contentTypes = default(List<string>), string declaredType = default(string), int? statusCode = default(int?))
        {
            this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MicrosoftAspNetCoreMvcOkObjectResultMicrosoftAspNetCoreMvcCore {\n");
