...
class IdeaRSCommonParametersParameterDataCIBasicTypes(BaseModel):
    """
    ...
    validation_type: Optional[IdeaRSCommonParametersValidationTypeCIBasicTypes] = Field(default=None, alias="validationType")
