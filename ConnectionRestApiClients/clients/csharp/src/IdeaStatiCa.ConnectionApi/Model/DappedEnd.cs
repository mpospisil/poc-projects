...
namespace IdeaStatiCa.ConnectionApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DappedEnd")]
    public partial class DappedEnd : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DappedEnd" /> class.
        /// </summary>
        /// <param name="id">Element Id.</param>
        public DappedEnd(int id = default(int))
        {
            this.Id = id;
        }
