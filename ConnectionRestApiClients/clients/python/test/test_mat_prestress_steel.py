...
class TestMatPrestressSteel(unittest.TestCase):
    """MatPrestressSteel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatPrestressSteel:
        """Test MatPrestressSteel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatPrestressSteel`
        """
        model = MatPrestressSteel()
        if include_optional:
            return MatPrestressSteel(
                diameter = 1.337,
                area = 1.337,
                number_of_wires = 56,
    ...
    def testMatPrestressSteel(self):
        """Test MatPrestressSteel"""
