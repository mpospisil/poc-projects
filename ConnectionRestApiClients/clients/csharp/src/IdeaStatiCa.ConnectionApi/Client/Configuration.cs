...
namespace IdeaStatiCa.ConnectionApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "24.0.6.1103";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/24.0.6.1103/csharp");
        ...
        {
            string report = "C# SDK (IdeaStatiCa.ConnectionApi) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0\n";
            report += "    SDK Package Version: 24.0.6.1103\n";
