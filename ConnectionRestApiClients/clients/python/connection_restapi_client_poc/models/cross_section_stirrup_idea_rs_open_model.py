...
class CrossSectionStirrupIdeaRSOpenModel(BaseModel):
    """
    CrossSectionStirrupIdeaRSOpenModel
    """ # noqa: E501
    geometry: Optional[Geometry2DPolyLine2DIdeaRSOpenModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geometry": Geometry2DPolyLine2DIdeaRSOpenModel.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "diameter": obj.get("diameter"),
            "material": ReferenceElementIdeaRSOpenModel.from_dict(obj["material"]) if obj.get("material") is not None else None,
