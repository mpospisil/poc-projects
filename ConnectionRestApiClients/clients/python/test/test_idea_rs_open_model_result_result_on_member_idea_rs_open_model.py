...
class TestIdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel:
        """Test IdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel`
        """
    ...
    def testIdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel(self):
        """Test IdeaRSOpenModelResultResultOnMemberIdeaRSOpenModel"""
