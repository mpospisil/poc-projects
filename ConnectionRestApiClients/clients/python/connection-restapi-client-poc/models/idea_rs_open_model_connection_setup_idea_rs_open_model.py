...
class IdeaRSOpenModelConnectionSetupIdeaRSOpenModel(BaseModel):
    """
    ...
    weld_evaluation_data: Optional[IdeaRSOpenModelWeldEvaluationIdeaRSOpenModel] = Field(default=None, alias="weldEvaluationData")
    check_detailing: Optional[StrictBool] = Field(default=None, alias="checkDetailing")
    apply_cone_breakout_check: Optional[IdeaRSOpenModelConeBreakoutCheckTypeIdeaRSOpenModel] = Field(default=None, alias="applyConeBreakoutCheck")
    ...
    crt_comp_check_is: Optional[IdeaRSOpenModelCrtCompCheckISIdeaRSOpenModel] = Field(default=None, alias="crtCompCheckIS")
