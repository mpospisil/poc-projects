...
class ConModelerConnectionPlugInPlateCheckResDataIdeaStatiCaConnectionChecks(BaseModel):
    """
    ...
    fire_temperature_calculation_data: Optional[IdeaRSConnectionCalculatorFireDesignFireTemperatureCalculationDataIdeaRSConnectionCalculator] = Field(default=None, alias="fireTemperatureCalculationData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fireTemperatureCalculationData": IdeaRSConnectionCalculatorFireDesignFireTemperatureCalculationDataIdeaRSConnectionCalculator.from_dict(obj["fireTemperatureCalculationData"]) if obj.get("fireTemperatureCalculationData") is not None else None,
