...
class IdeaRSOpenModelGeometry2DPolyLine2DIdeaRSOpenModel(BaseModel):
    """
    IdeaRSOpenModelGeometry2DPolyLine2DIdeaRSOpenModel
    """ # noqa: E501
    start_point: Optional[IdeaRSOpenModelGeometry2DPoint2DIdeaRSOpenModel] = Field(default=None, alias="startPoint")
    segments: Optional[List[IdeaRSOpenModelGeometry2DSegment2DIdeaRSOpenModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "startPoint": IdeaRSOpenModelGeometry2DPoint2DIdeaRSOpenModel.from_dict(obj["startPoint"]) if obj.get("startPoint") is not None else None,
            "segments": [IdeaRSOpenModelGeometry2DSegment2DIdeaRSOpenModel.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
