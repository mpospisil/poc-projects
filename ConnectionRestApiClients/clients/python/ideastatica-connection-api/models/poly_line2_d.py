...
class PolyLine2D(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "startPoint": Point2D.from_dict(obj["startPoint"]) if obj.get("startPoint") is not None else None,
            "segments": [Segment2D.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
