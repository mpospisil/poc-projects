...
class IdeaRSOpenModelConnectionBendDataIdeaRSOpenModel(BaseModel):
    """
    ...
    point1_of_side_boundary1: Optional[IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel] = Field(default=None, alias="point1OfSideBoundary1")
    point2_of_side_boundary1: Optional[IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel] = Field(default=None, alias="point2OfSideBoundary1")
    end_face_normal1: Optional[IdeaRSOpenModelGeometry3DVector3DIdeaRSOpenModel] = Field(default=None, alias="endFaceNormal1")
    point1_of_side_boundary2: Optional[IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel] = Field(default=None, alias="point1OfSideBoundary2")
    point2_of_side_boundary2: Optional[IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel] = Field(default=None, alias="point2OfSideBoundary2")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "point1OfSideBoundary1": IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel.from_dict(obj["point1OfSideBoundary1"]) if obj.get("point1OfSideBoundary1") is not None else None,
            "point2OfSideBoundary1": IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel.from_dict(obj["point2OfSideBoundary1"]) if obj.get("point2OfSideBoundary1") is not None else None,
            "endFaceNormal1": IdeaRSOpenModelGeometry3DVector3DIdeaRSOpenModel.from_dict(obj["endFaceNormal1"]) if obj.get("endFaceNormal1") is not None else None,
            "point1OfSideBoundary2": IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel.from_dict(obj["point1OfSideBoundary2"]) if obj.get("point1OfSideBoundary2") is not None else None,
            "point2OfSideBoundary2": IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel.from_dict(obj["point2OfSideBoundary2"]) if obj.get("point2OfSideBoundary2") is not None else None
        })
        return _obj
