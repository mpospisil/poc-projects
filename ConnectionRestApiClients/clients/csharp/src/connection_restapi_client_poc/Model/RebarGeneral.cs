...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RebarGeneral")]
    public partial class RebarGeneral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RebarGeneral" /> class.
        /// </summary>
        /// <param name="id">Element Id.</param>
        public RebarGeneral(int id = default(int))
        {
            this.Id = id;
        }
