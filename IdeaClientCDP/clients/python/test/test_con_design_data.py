...
class TestConDesignData(unittest.TestCase):
    """ConDesignData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConDesignData:
        """Test ConDesignData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConDesignData`
        """
        model = ConDesignData()
        if include_optional:
            return ConDesignData(
