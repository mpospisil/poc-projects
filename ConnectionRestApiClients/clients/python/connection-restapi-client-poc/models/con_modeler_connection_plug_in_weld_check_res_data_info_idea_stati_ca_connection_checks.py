...
class ConModelerConnectionPlugInWeldCheckResDataInfoIdeaStatiCaConnectionChecks(BaseModel):
    """
    ...
    welding_type: Optional[IdeaStatiCaConnectionBasicTypesDataWeldingTypeSNIPCIBasicTypes] = Field(default=None, alias="weldingType")
