...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "System_IO_MemoryStream-System_Private_CoreLib")]
    public partial class SystemIOMemoryStreamSystemPrivateCoreLib : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemIOMemoryStreamSystemPrivateCoreLib" /> class.
        /// </summary>
        /// <param name="capacity">capacity.</param>
        /// <param name="position">position.</param>
        /// <param name="readTimeout">readTimeout.</param>
        /// <param name="writeTimeout">writeTimeout.</param>
        public SystemIOMemoryStreamSystemPrivateCoreLib(int capacity = default(int), long position = default(long), int readTimeout = default(int), int writeTimeout = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemIOMemoryStreamSystemPrivateCoreLib {\n");
