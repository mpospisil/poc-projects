...
class TestConnectionSetup(unittest.TestCase):
    """ConnectionSetup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionSetup:
        """Test ConnectionSetup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionSetup`
        """
        model = ConnectionSetup()
        if include_optional:
