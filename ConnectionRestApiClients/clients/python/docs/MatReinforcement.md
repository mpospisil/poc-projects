...
------------ | ------------- | ------------- | -------------
**bar_surface** | [**ReinfBarSurface**](ReinfBarSurface.md) |  | [optional] 
...
json = "{}"
# create an instance of MatReinforcement from a JSON string
mat_reinforcement_instance = MatReinforcement.from_json(json)
# print the JSON string representation of the object
print(MatReinforcement.to_json())

# convert the object into a dict
mat_reinforcement_dict = mat_reinforcement_instance.to_dict()
# create an instance of MatReinforcement from a dict
mat_reinforcement_from_dict = MatReinforcement.from_dict(mat_reinforcement_dict)
```
