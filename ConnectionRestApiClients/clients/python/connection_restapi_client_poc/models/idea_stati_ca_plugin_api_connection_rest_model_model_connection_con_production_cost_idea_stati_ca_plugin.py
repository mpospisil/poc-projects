...
class IdeaStatiCaPluginApiConnectionRestModelModelConnectionConProductionCostIdeaStatiCaPlugin(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["totalEstimatedCost"]
