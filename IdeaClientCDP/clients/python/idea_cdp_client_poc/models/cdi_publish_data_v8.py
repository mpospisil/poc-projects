...
class CdiPublishDataV8(BaseModel):
    """
    CdiPublishDataV8
    """ # noqa: E501
    con_design_item: Optional[ConDesignItem] = Field(default=None, alias="conDesignItem")
    picture_upload_id: Optional[StrictStr] = Field(default=None, alias="pictureUploadId")
    project_upload_id: Optional[StrictStr] = Field(default=None, alias="projectUploadId")
    scene3_d_upload_id: Optional[StrictStr] = Field(default=None, alias="scene3DUploadId")
    __properties: ClassVar[List[str]] = ["conDesignItem", "pictureUploadId", "projectUploadId", "scene3DUploadId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pictureUploadId": obj.get("pictureUploadId"),
            "projectUploadId": obj.get("projectUploadId"),
            "scene3DUploadId": obj.get("scene3DUploadId")
        })
        return _obj
