...
class TestCdiPublishDataV8(unittest.TestCase):
    """CdiPublishDataV8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CdiPublishDataV8:
        """Test CdiPublishDataV8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CdiPublishDataV8`
        """
        model = CdiPublishDataV8()
        if include_optional:
            return CdiPublishDataV8(
