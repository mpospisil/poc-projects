...
class IdeaRSOpenModelOpenModelContainerIdeaRSOpenModel(BaseModel):
    """
    IdeaRSOpenModelOpenModelContainerIdeaRSOpenModel
    """ # noqa: E501
    open_model: Optional[IdeaRSOpenModelOpenModelIdeaRSOpenModel] = Field(default=None, alias="openModel")
    open_model_result: Optional[IdeaRSOpenModelResultOpenModelResultIdeaRSOpenModel] = Field(default=None, alias="openModelResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "openModel": IdeaRSOpenModelOpenModelIdeaRSOpenModel.from_dict(obj["openModel"]) if obj.get("openModel") is not None else None,
            "openModelResult": IdeaRSOpenModelResultOpenModelResultIdeaRSOpenModel.from_dict(obj["openModelResult"]) if obj.get("openModelResult") is not None else None
        })
        return _obj
