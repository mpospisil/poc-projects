...
class TestMatWelding(unittest.TestCase):
    """MatWelding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatWelding:
        """Test MatWelding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatWelding`
        """
        model = MatWelding()
        if include_optional:
            return MatWelding(
