...
class IdeaRSOpenModelConnectionAnchorGridIdeaRSOpenModel(BaseModel):
    """
    IdeaRSOpenModelConnectionAnchorGridIdeaRSOpenModel
    """ # noqa: E501
    concrete_block: Optional[IdeaRSOpenModelConnectionConcreteBlockIdeaRSOpenModel] = Field(default=None, alias="concreteBlock")
    anchor_type: Optional[IdeaRSOpenModelParametersAnchorTypeIdeaRSOpenModel] = Field(default=None, alias="anchorType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "concreteBlock": IdeaRSOpenModelConnectionConcreteBlockIdeaRSOpenModel.from_dict(obj["concreteBlock"]) if obj.get("concreteBlock") is not None else None,
