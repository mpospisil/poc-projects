...
namespace IdeaStatiCa.ConnectionApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Reinforcement")]
    public partial class Reinforcement : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Reinforcement" /> class.
        /// </summary>
        /// <param name="id">Element Id.</param>
        public Reinforcement(int id = default(int))
        {
            this.Id = id;
        }
