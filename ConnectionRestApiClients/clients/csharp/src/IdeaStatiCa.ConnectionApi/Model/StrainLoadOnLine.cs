...
namespace IdeaStatiCa.ConnectionApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StrainLoadOnLine")]
    public partial class StrainLoadOnLine : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StrainLoadOnLine" /> class.
        /// </summary>
        /// <param name="id">Element Id.</param>
        public StrainLoadOnLine(int id = default(int))
        {
            this.Id = id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StrainLoadOnLine {\n");
