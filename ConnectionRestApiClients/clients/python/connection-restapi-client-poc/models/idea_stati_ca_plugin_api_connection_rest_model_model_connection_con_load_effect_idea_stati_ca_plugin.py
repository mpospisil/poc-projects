...
class IdeaStatiCaPluginApiConnectionRestModelModelConnectionConLoadEffectIdeaStatiCaPlugin(BaseModel):
    """
    ...
    member_loadings: Optional[List[IdeaStatiCaPluginApiConnectionRestModelModelConnectionConLoadEffectMemberLoadIdeaStatiCaPlugin]] = Field(default=None, alias="memberLoadings")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.member_loadings:
            for _item in self.member_loadings:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberLoadings": [IdeaStatiCaPluginApiConnectionRestModelModelConnectionConLoadEffectMemberLoadIdeaStatiCaPlugin.from_dict(_item) for _item in obj["memberLoadings"]] if obj.get("memberLoadings") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
