...
class ProjectApi:
    ...
    def _get_project_data_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1/projects/{projectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_project_data(
        ...
        con_project_data: Optional[ConProjectData] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_project_data_serialize(
            project_id=project_id,
            con_project_data=con_project_data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_project_data_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if con_project_data is not None:
            _body_params = con_project_data
