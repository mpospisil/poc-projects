...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CheckResAnchor")]
    public partial class CheckResAnchor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckResAnchor" /> class.
        /// </summary>
        /// <param name="name">Name.</param>
        /// <param name="unityCheck">Unity Check.</param>
        /// <param name="checkStatus">Status of the Check.</param>
        public CheckResAnchor(string name = default(string), double unityCheck = default(double), bool checkStatus = default(bool))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CheckResAnchor {\n");
