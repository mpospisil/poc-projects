...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdeaStatiCa_Api_Connection_Model_ConMember-IdeaStatiCa_Api")]
    public partial class IdeaStatiCaApiConnectionModelConMemberIdeaStatiCaApi : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdeaStatiCaApiConnectionModelConMemberIdeaStatiCaApi" /> class.
        /// </summary>
        ...
        public IdeaStatiCaApiConnectionModelConMemberIdeaStatiCaApi(bool isContinuous = default(bool), int? crossSectionId = default(int?), bool? mirrorY = default(bool?), bool? mirrorZ = default(bool?), bool isBearing = default(bool), int id = default(int), string name = default(string), bool active = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdeaStatiCaApiConnectionModelConMemberIdeaStatiCaApi {\n");
