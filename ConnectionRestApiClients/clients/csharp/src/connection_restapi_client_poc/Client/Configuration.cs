...
namespace connection_restapi_client_poc.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "24.0.5.0665";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/24.0.5.0665/csharp");
        ...
        {
            string report = "C# SDK (connection_restapi_client_poc) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0\n";
            report += "    SDK Package Version: 24.0.5.0665\n";
