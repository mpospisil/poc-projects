...
export class ExportApi {
     ...
     * @param connectionId 
     */
    public async exportConnectionData (projectId: string, connectionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConnectionData;  }> {
     ...
     * @param version 
     */
    public async exportIomXml (projectId: string, connectionId: number, version?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
