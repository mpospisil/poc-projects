...
class CrossSectionReinforcedCrossSectionIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "crossSection": ReferenceElementIdeaRSOpenModel.from_dict(obj["crossSection"]) if obj.get("crossSection") is not None else None,
            "bars": [CrossSectionReinforcedBarIdeaRSOpenModel.from_dict(_item) for _item in obj["bars"]] if obj.get("bars") is not None else None,
            "stirrups": [CrossSectionStirrupIdeaRSOpenModel.from_dict(_item) for _item in obj["stirrups"]] if obj.get("stirrups") is not None else None,
            "tendonBars": [CrossSectionTendonBarIdeaRSOpenModel.from_dict(_item) for _item in obj["tendonBars"]] if obj.get("tendonBars") is not None else None,
            "tendonDucts": [CrossSectionTendonDuctIdeaRSOpenModel.from_dict(_item) for _item in obj["tendonDucts"]] if obj.get("tendonDucts") is not None else None,
            "id": obj.get("id")
        })
        return _obj
