...
exports.ParameterApi = exports.ParameterApiApiKeys = void 0;
...
// ===============================================
var ParameterApiApiKeys;
(function (ParameterApiApiKeys) {
})(ParameterApiApiKeys || (exports.ParameterApiApiKeys = ParameterApiApiKeys = {}));
class ParameterApi {
    ...
    setApiKey(key, value) {
        this.authentications[ParameterApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    evaluateExpression(projectId_1, connectionId_1, body_1) {
        return __awaiter(this, arguments, void 0, function* (projectId, connectionId, body, options = { headers: {} }) {
     ...
     */
    getParameters(projectId_1, connectionId_1, includeHidden_1) {
        return __awaiter(this, arguments, void 0, function* (projectId, connectionId, includeHidden, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<IdeaParameter>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
     ...
     */
    updateParameters(projectId_1, connectionId_1, ideaParameterUpdate_1) {
        return __awaiter(this, arguments, void 0, function* (projectId, connectionId, ideaParameterUpdate, options = { headers: {} }) {
            const localVarPath = this.basePath + '/api/1/projects/{projectId}/connections/{connectionId}/parameters'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'connectionId' + '}', encodeURIComponent(String(connectionId)));
            let localVarQueryParameters = {};
            ...
            // verify required parameter 'projectId' is not null or undefined
            if (projectId === null || projectId === undefined) {
                throw new Error('Required parameter projectId was null or undefined when calling updateParameters.');
            }
            // verify required parameter 'connectionId' is not null or undefined
            if (connectionId === null || connectionId === undefined) {
                throw new Error('Required parameter connectionId was null or undefined when calling updateParameters.');
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(ideaParameterUpdate, "Array<IdeaParameterUpdate>")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<ParameterData>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
