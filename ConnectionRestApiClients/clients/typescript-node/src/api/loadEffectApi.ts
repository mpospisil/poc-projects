...
export class LoadEffectApi {
     ...
     * @param conLoadEffect 
     */
    public async addLoadEffect (projectId: string, connectionId: number, conLoadEffect?: ConLoadEffect, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConLoadEffect;  }> {
     ...
     * @param conLoadEffect 
     */
    public async updateLoadEffect (projectId: string, connectionId: number, conLoadEffect?: ConLoadEffect, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConLoadEffect;  }> {
        const localVarPath = this.basePath + '/api/1/projects/{projectId}/connections/{connectionId}/load-effects'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'connectionId' + '}', encodeURIComponent(String(connectionId)));
        let localVarQueryParameters: any = {};
