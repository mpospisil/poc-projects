...
namespace connection_restapi_client_poc.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenModelContainerIdeaRSOpenModel" /> class.
        /// </summary>
        /// <param name="openModel">openModel.</param>
        /// <param name="openModelResult">openModelResult.</param>
        public OpenModelContainerIdeaRSOpenModel(OpenModelIdeaRSOpenModel openModel = default(OpenModelIdeaRSOpenModel), ResultOpenModelResultIdeaRSOpenModel openModelResult = default(ResultOpenModelResultIdeaRSOpenModel))
        {
        ...
        public OpenModelIdeaRSOpenModel OpenModel { get; set; }

        /// <summary>
        /// Gets or Sets OpenModelResult
        /// </summary>
        [DataMember(Name = "openModelResult", EmitDefaultValue = false)]
        public ResultOpenModelResultIdeaRSOpenModel OpenModelResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenModelContainerIdeaRSOpenModel {\n");
