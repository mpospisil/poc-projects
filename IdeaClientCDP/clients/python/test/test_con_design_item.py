...
class TestConDesignItem(unittest.TestCase):
    """ConDesignItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConDesignItem:
        """Test ConDesignItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConDesignItem`
        """
        model = ConDesignItem()
        if include_optional:
            return ConDesignItem(
                picture_id = '',
                version = '',
                name = '0',
                owner_id = '',
