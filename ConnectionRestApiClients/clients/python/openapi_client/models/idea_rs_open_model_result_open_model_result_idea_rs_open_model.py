...
class IdeaRSOpenModelResultOpenModelResultIdeaRSOpenModel(BaseModel):
    """
    IdeaRSOpenModelResultOpenModelResultIdeaRSOpenModel
    """ # noqa: E501
    result_on_members: Optional[List[IdeaRSOpenModelResultResultOnMembersIdeaRSOpenModel]] = Field(default=None, alias="resultOnMembers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resultOnMembers": [IdeaRSOpenModelResultResultOnMembersIdeaRSOpenModel.from_dict(_item) for _item in obj["resultOnMembers"]] if obj.get("resultOnMembers") is not None else None
        })
        return _obj
