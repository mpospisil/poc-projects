...
class IdeaStatiCaPluginApiConnectionRestModelModelConnectionConConnectionIdeaStatiCaPlugin(BaseModel):
    """
    ...
    analysis_type: Optional[IdeaStatiCaPluginApiConnectionRestModelModelConnectionConAnalysisTypeEnumIdeaStatiCaPlugin] = Field(default=None, alias="analysisType")
    load_options: Optional[IdeaStatiCaPluginApiConnectionRestModelModelSettingsConLoadingOptionsIdeaStatiCaPlugin] = Field(default=None, alias="loadOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loadOptions": IdeaStatiCaPluginApiConnectionRestModelModelSettingsConLoadingOptionsIdeaStatiCaPlugin.from_dict(obj["loadOptions"]) if obj.get("loadOptions") is not None else None,
