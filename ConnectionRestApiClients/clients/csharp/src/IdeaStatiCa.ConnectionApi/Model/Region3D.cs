...
namespace IdeaStatiCa.ConnectionApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Region3D")]
    public partial class Region3D : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Region3D" /> class.
        /// </summary>
        /// <param name="id">Element Id.</param>
        public Region3D(int id = default(int))
        {
            this.Id = id;
        }
