...
class IdeaStatiCaPluginApiConnectionRestModelModelConnectionConLoadEffectSectionLoadIdeaStatiCaPlugin(BaseModel):
    """
    ...
    vz: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["n", "vy", "vz", "mx", "my", "mz"]
