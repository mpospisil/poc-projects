...
class TestCIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes:
        """Test CIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes`
        """
        model = CIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes()
        if include_optional:
    ...
    def testCIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes(self):
        """Test CIConnectionsDataAutoDesignBoltCoordinateSystemCIBasicTypes"""
