...
class Anchoring(BaseModel):
    ...
    anchoring_type: Optional[AnchoringType] = Field(default=None, alias="anchoringType")
    __properties: ClassVar[List[str]] = ["count", "anchoringType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "anchoringType": obj.get("anchoringType")
        })
        return _obj
