...
class GussetPlate(BaseModel):
    ...
    gusset_plate_type: Optional[MaterialType] = Field(default=None, alias="gussetPlateType")
    __properties: ClassVar[List[str]] = ["count", "gussetPlateType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "gussetPlateType": obj.get("gussetPlateType")
        })
        return _obj
