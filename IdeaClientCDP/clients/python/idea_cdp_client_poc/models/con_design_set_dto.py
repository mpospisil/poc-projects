...
class ConDesignSetDto(BaseModel):
    """
    ConDesignSetDto
    """ # noqa: E501
    ...
    type: Optional[ConDesignSetType] = None
    permissions: Optional[List[Permission]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "readOnly", "ownerId", "created", "modified", "type", "permissions"]
