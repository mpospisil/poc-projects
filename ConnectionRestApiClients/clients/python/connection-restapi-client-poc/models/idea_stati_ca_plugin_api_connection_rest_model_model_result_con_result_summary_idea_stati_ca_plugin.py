...
class IdeaStatiCaPluginApiConnectionRestModelModelResultConResultSummaryIdeaStatiCaPlugin(BaseModel):
    """
    IdeaStatiCaPluginApiConnectionRestModelModelResultConResultSummaryIdeaStatiCaPlugin
    """ # noqa: E501
    id: Optional[StrictInt] = None
    passed: Optional[StrictBool] = None
    result_summary: Optional[List[IdeaRSOpenModelConnectionCheckResSummaryIdeaRSOpenModel]] = Field(default=None, alias="resultSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resultSummary": [IdeaRSOpenModelConnectionCheckResSummaryIdeaRSOpenModel.from_dict(_item) for _item in obj["resultSummary"]] if obj.get("resultSummary") is not None else None
        })
        return _obj
