...
class IdeaStatiCaPluginApiConnectionRestModelModelConnectionConOperationIdeaStatiCaPlugin(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "isActive", "isImported"]
