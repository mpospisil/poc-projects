...
class TestConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks(unittest.TestCase):
    """ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks:
        """Test ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks`
        """
        model = ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks()
        if include_optional:
            return ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks(
    ...
    def testConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks(self):
        """Test ConModelerConnectionPlugInBoltCheckResDataTimberIdeaStatiCaConnectionChecks"""
