...
class SystemIOMemoryStreamSystemPrivateCoreLib(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["canRead", "canSeek", "canWrite", "capacity", "length", "position", "canTimeout", "readTimeout", "writeTimeout"]
