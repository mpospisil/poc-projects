...
class TestConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks:
        """Test ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks`
        """
        model = ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks()
        if include_optional:
            return ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks(
    ...
    def testConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks(self):
        """Test ConModelerConnectionPlugInAnalysisCheckResDataIdeaStatiCaConnectionChecks"""
