...
[**get_raw_results**](CalculationApi.md#get_raw_results) | **POST** /api/1/projects/{projectId}/rawresults | Get raw CBFEM results (an instance of CheckResultsData)
...
# **get_raw_results**
> CheckResultsDataIdeaStatiCaConnectionChecks get_raw_results(project_id, idea_stati_ca_api_connection_model_con_calculation_parameter_idea_stati_ca_api=idea_stati_ca_api_connection_model_con_calculation_parameter_idea_stati_ca_api)
...
with connection_restapi_client_poc.ApiClient(configuration) as api_client:
    ...
    try:
        # Get raw CBFEM results (an instance of CheckResultsData)
        api_response = api_instance.get_raw_results(project_id, idea_stati_ca_api_connection_model_con_calculation_parameter_idea_stati_ca_api=idea_stati_ca_api_connection_model_con_calculation_parameter_idea_stati_ca_api)
