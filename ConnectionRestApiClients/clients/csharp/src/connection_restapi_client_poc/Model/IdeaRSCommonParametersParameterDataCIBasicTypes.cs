...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdeaRS_Common_Parameters_ParameterData-CI_BasicTypes")]
    public partial class IdeaRSCommonParametersParameterDataCIBasicTypes : IValidatableObject
    {
        ...
        public IdeaRSCommonParametersValidationTypeCIBasicTypes? ValidationType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdeaRSCommonParametersParameterDataCIBasicTypes" /> class.
        /// </summary>
        ...
        public IdeaRSCommonParametersParameterDataCIBasicTypes(int id = default(int), string identifier = default(string), string description = default(string), string parameterType = default(string), Object value = default(Object), Object defaultValue = default(Object), Object evaluatedValue = default(Object), Object evaluatedDefaultValue = default(Object), string validationValue = default(string), string evaluatedValidationValue = default(string), IdeaRSCommonParametersValidationTypeCIBasicTypes? validationType = default(IdeaRSCommonParametersValidationTypeCIBasicTypes?), int userUnitId = default(int), bool isVisibleForSimpleConnection = default(bool))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdeaRSCommonParametersParameterDataCIBasicTypes {\n");
