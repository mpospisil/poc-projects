...
class ConPart(BaseModel):
    """
    ConPart
    """ # noqa: E501
    stiffness: Optional[StiffnessCategoryTypes] = None
    category: Optional[ConPartCategoryTypes] = None
    __properties: ClassVar[List[str]] = ["stiffness", "category"]
