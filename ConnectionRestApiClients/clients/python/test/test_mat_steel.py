...
class TestMatSteel(unittest.TestCase):
    """MatSteel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatSteel:
        """Test MatSteel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatSteel`
        """
        model = MatSteel()
        if include_optional:
            return MatSteel(
