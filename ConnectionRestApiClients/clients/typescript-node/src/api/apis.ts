...
export const APIS = [CalculationApi, ClientApi, ConnectionApi, ConversionApi, ExportApi, LoadEffectApi, MaterialApi, MemberApi, OperationApi, ParameterApi, PresentationApi, ProjectApi, ReportApi, TemplateApi];
