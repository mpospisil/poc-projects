...
class ConnectionApi:
    ...
    def delete_operations(
        ...
        connection_id: Annotated[StrictInt, Field(description="Id of the connection to be modified")],
        ...
        :type project_id: str
        :param connection_id: Id of the connection to be modified (required)
    ...
    @validate_call
    def get_missing_welds(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service")],
        connection_id: Annotated[StrictInt, Field(description="Id of the requested connection in the project")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The unique identifier of the opened project in the ConnectionRestApi service (required)
        :type project_id: str
        :param connection_id: Id of the requested connection in the project (required)
        :type connection_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_missing_welds_serialize(
            project_id=project_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_missing_welds_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service")],
        connection_id: Annotated[StrictInt, Field(description="Id of the requested connection in the project")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_missing_welds_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service")],
        connection_id: Annotated[StrictInt, Field(description="Id of the requested connection in the project")],
        _request_timeout: Union[
    ...
    def _get_missing_welds_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
