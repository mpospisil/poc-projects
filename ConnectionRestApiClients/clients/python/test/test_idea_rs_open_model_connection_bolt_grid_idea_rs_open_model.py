...
class TestIdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel:
        """Test IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel`
        """
        model = IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel()
        if include_optional:
            return IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel(
                bolt_assembly_ref = '',
                id = 56,
                is_anchor = True,
                anchor_len = 1.337,
    ...
    def testIdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel(self):
        """Test IdeaRSOpenModelConnectionBoltGridIdeaRSOpenModel"""
