...
namespace connection_restapi_client_poc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdeaStatiCa_Api_Connection_Model_ConMissingWeld-IdeaStatiCa_Api")]
    public partial class IdeaStatiCaApiConnectionModelConMissingWeldIdeaStatiCaApi : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdeaStatiCaApiConnectionModelConMissingWeldIdeaStatiCaApi" /> class.
        /// </summary>
        ...
        public IdeaStatiCaApiConnectionModelConMissingWeldIdeaStatiCaApi(string edgePlate = default(string), string surfacePlate = default(string), int edgeIndex = default(int), int surfaceIndex = default(int), double weldSize = default(double), string weldTypeCode = default(string), string weldMaterialName = default(string), bool isHollowOrUncoiledSection = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdeaStatiCaApiConnectionModelConMissingWeldIdeaStatiCaApi {\n");
