...
class ConParameterApi:
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_evaluate_expression_post(
        self,
        ...
        _param = self._api1_con_parameter_project_id_connection_id_evaluate_expression_post_serialize(
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_evaluate_expression_post_with_http_info(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        body: Optional[StrictStr] = None,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_evaluate_expression_post_without_preload_content(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        body: Optional[StrictStr] = None,
    ...
    def _api1_con_parameter_project_id_connection_id_evaluate_expression_post_serialize(
        self,
        project_id,
        connection_id,
        body,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/1/ConParameter/{projectId}/{connectionId}/EvaluateExpression',
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_get(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        ...
        _param = self._api1_con_parameter_project_id_connection_id_parameter_get_serialize(
            project_id=project_id,
            connection_id=connection_id,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_get_with_http_info(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        include_hidden: Optional[StrictBool] = None,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_get_without_preload_content(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        include_hidden: Optional[StrictBool] = None,
    ...
    def _api1_con_parameter_project_id_connection_id_parameter_get_serialize(
        self,
        project_id,
        connection_id,
        include_hidden,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1/ConParameter/{projectId}/{connectionId}/Parameter',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_put(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        ...
        _param = self._api1_con_parameter_project_id_connection_id_parameter_put_serialize(
            project_id=project_id,
            connection_id=connection_id,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_put_with_http_info(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        idea_stati_ca_plugin_api_connection_rest_model_model_parameter_idea_parameter_update_idea_stati_ca_plugin: Optional[List[IdeaStatiCaPluginApiConnectionRestModelModelParameterIdeaParameterUpdateIdeaStatiCaPlugin]] = None,
    ...
    @validate_call
    def api1_con_parameter_project_id_connection_id_parameter_put_without_preload_content(
        self,
        project_id: StrictStr,
        connection_id: StrictInt,
        idea_stati_ca_plugin_api_connection_rest_model_model_parameter_idea_parameter_update_idea_stati_ca_plugin: Optional[List[IdeaStatiCaPluginApiConnectionRestModelModelParameterIdeaParameterUpdateIdeaStatiCaPlugin]] = None,
    ...
    def _api1_con_parameter_project_id_connection_id_parameter_put_serialize(
        self,
        project_id,
        connection_id,
