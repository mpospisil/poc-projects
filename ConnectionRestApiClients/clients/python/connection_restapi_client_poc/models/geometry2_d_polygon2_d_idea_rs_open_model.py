...
class Geometry2DPolygon2DIdeaRSOpenModel(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "points": [Geometry2DPoint2DIdeaRSOpenModel.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None
        })
        return _obj
