...
class IdeaRSOpenModelConnectionCutDataIdeaRSOpenModel(BaseModel):
    """
    IdeaRSOpenModelConnectionCutDataIdeaRSOpenModel
    """ # noqa: E501
    plane_point: Optional[IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel] = Field(default=None, alias="planePoint")
    normal_vector: Optional[IdeaRSOpenModelGeometry3DVector3DIdeaRSOpenModel] = Field(default=None, alias="normalVector")
    direction: Optional[IdeaRSOpenModelConnectionCutOrientationIdeaRSOpenModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "planePoint": IdeaRSOpenModelGeometry3DPoint3DIdeaRSOpenModel.from_dict(obj["planePoint"]) if obj.get("planePoint") is not None else None,
            "normalVector": IdeaRSOpenModelGeometry3DVector3DIdeaRSOpenModel.from_dict(obj["normalVector"]) if obj.get("normalVector") is not None else None,
