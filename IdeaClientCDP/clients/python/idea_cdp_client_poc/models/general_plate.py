...
class GeneralPlate(BaseModel):
    """
    GeneralPlate
    """ # noqa: E501
    count: Optional[StrictInt] = None
    general_plate_type: Optional[GeneralPlateType] = Field(default=None, alias="generalPlateType")
    __properties: ClassVar[List[str]] = ["count", "generalPlateType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "generalPlateType": obj.get("generalPlateType")
        })
        return _obj
