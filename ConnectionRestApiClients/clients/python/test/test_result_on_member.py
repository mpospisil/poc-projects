...
class TestResultOnMember(unittest.TestCase):
    """ResultOnMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResultOnMember:
        """Test ResultOnMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResultOnMember`
        """
        model = ResultOnMember()
        if include_optional:
