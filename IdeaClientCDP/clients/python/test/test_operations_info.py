...
class TestOperationsInfo(unittest.TestCase):
    """OperationsInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationsInfo:
        """Test OperationsInfo
