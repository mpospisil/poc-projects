...
class ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationResultsIdeaStatiCaConnectionChecks(BaseModel):
    """
    ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationResultsIdeaStatiCaConnectionChecks
    """ # noqa: E501
    steel_costs: Optional[List[ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemSteelIdeaStatiCaConnectionChecks]] = Field(default=None, alias="steelCosts")
    fillet_weld_costs: Optional[List[ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemWeldIdeaStatiCaConnectionChecks]] = Field(default=None, alias="filletWeldCosts")
    butt_weld_costs: Optional[List[ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemWeldIdeaStatiCaConnectionChecks]] = Field(default=None, alias="buttWeldCosts")
    bolt_costs: Optional[List[ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemBoltIdeaStatiCaConnectionChecks]] = Field(default=None, alias="boltCosts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "steelCosts": [ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemSteelIdeaStatiCaConnectionChecks.from_dict(_item) for _item in obj["steelCosts"]] if obj.get("steelCosts") is not None else None,
            "filletWeldCosts": [ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemWeldIdeaStatiCaConnectionChecks.from_dict(_item) for _item in obj["filletWeldCosts"]] if obj.get("filletWeldCosts") is not None else None,
            "buttWeldCosts": [ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemWeldIdeaStatiCaConnectionChecks.from_dict(_item) for _item in obj["buttWeldCosts"]] if obj.get("buttWeldCosts") is not None else None,
            "boltCosts": [ConModelerConnectionPlugInDataContractCostEstimationDataCostEstimationItemBoltIdeaStatiCaConnectionChecks.from_dict(_item) for _item in obj["boltCosts"]] if obj.get("boltCosts") is not None else None,
