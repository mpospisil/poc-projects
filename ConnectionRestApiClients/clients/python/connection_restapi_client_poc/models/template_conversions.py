...
class TemplateConversions(BaseModel):
    ...
    TemplateConversions
    """ # noqa: E501
    conversions: Optional[List[BaseTemplateConversion]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversions": [BaseTemplateConversion.from_dict(_item) for _item in obj["conversions"]] if obj.get("conversions") is not None else None,
